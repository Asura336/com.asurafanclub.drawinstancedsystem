...
namespace Com.Rendering.Editor
{
    ...
    {
        const string useInstancedColor = "useInstancedColor";

        static readonly string[] workflowModeNames = Enum.GetNames(typeof(LitGUI.WorkflowMode));

        private LitGUI.LitProperties litProperties;
        private InstancedLitDetailGUI.LitProperties litDetailProperties;

        MaterialProperty useColorBuffer;


        public override void FillAdditionalFoldouts(MaterialHeaderScopeList materialScopesList)
        {
            materialScopesList.RegisterHeaderScope(InstancedLitDetailGUI.Styles.detailInputs, Expandable.Details, _ => InstancedLitDetailGUI.DoDetailArea(litDetailProperties, materialEditor));
        }
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            litDetailProperties = new InstancedLitDetailGUI.LitProperties(properties);

            useColorBuffer = FindProperty(useInstancedColor, properties);
        }

        // material changed check
        public override void ValidateMaterial(Material material)
        {
            SetMaterialKeywords(material, LitGUI.SetMaterialKeywords, InstancedLitDetailGUI.SetMaterialKeywords);
        }
        ...
        public override void DrawAdvancedOptions(Material material)
        {
            ...
            materialEditor.ShaderProperty(useColorBuffer, "使用颜色缓冲区");
        }
    ...
    internal class InstancedLitDetailGUI
    {
