#ifndef ASURAFANCLUB_INSTANCED_LIT_INPUT_INCLUDED
    #define ASURAFANCLUB_INSTANCED_LIT_INPUT_INCLUDED
    ...
    /* 实例化绘制重载的变换过程
    * 实例化绘制写入了 localToWorld 变换，需要重写涉及到模型空间和世界空间之间变换的部分
    */
    ...
    void ConfigureProcedural()
    {
            ...
            UNITY_MATRIX_M = _Matrices[unity_InstanceID];
            UNITY_MATRIX_I_M = inverse(UNITY_MATRIX_M);
        #endif
    }
